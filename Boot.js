var BasicGame = {
    ...
    // Enemy spawn delay
    SPAWN_BASIC_DELAY: Phaser.Timer.SECOND * 0.015,
    SPAWN_SCARY_DELAY: Phaser.Timer.SECOND * 4 * 0.015,
