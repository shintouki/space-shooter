var BasicGame = {
    ...
    LASER_DELAY: Phaser.Timer.SECOND * 0.2,
    ...
    // Enemy spawn delay
    SPAWN_BASIC_DELAY: Phaser.Timer.SECOND * 0,
    ...
    // Power up drop rate
    BASIC_ENEMY_LASER_DROP_RATE: 0.025,
    SCARY_ENEMY_LASER_DROP_RATE: 0.05,
    BASIC_ENEMY_MISSILE_DROP_RATE: 0.05,
    SCARY_ENEMY_MISSILE_DROP_RATE: 0.1,
    BASIC_ENEMY_FIREBALL_DROP_RATE: 0.025,
    SCARY_ENEMY_FIREBALL_DROP_RATE: 0.05,

    // Debug mode drop rate
    // BASIC_ENEMY_LASER_DROP_RATE: 0,
    // SCARY_ENEMY_LASER_DROP_RATE: 0,
    // BASIC_ENEMY_MISSILE_DROP_RATE: 0,
    // SCARY_ENEMY_MISSILE_DROP_RATE: 0,
    // BASIC_ENEMY_FIREBALL_DROP_RATE: 1,
    // SCARY_ENEMY_FIREBALL_DROP_RATE: 1,
